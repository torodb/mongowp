 ...
 * matteom
 */
public enum ReplicationQueryCommand implements QueryCommandProcessor.QueryCommand {
    applyOps,
    getoptime,
    isMaster {
        @Override
    ...
    private ReplicationQueryCommand() {
    	this.key = name();
    }
    
    private ReplicationQueryCommand(String key) {
    	this.key = key;
    }
