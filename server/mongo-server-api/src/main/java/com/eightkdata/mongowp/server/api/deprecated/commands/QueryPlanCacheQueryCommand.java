 ...
 * matteom
 */
public enum QueryPlanCacheQueryCommand implements QueryCommandProcessor.QueryCommand {
    ...
    private QueryPlanCacheQueryCommand() {
    	this.key = name();
    }
    
    private QueryPlanCacheQueryCommand(String key) {
    	this.key = key;
    }
