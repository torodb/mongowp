 ...
 * matteom
 */
public enum SystemEventsAuditingQueryCommand implements QueryCommandProcessor.QueryCommand {
    //logApplicationMessage
    ;
    
    private final String key;
    
    private SystemEventsAuditingQueryCommand() {
    	this.key = name();
    }
    
    private SystemEventsAuditingQueryCommand(String key) {
    	this.key = key;
    }
