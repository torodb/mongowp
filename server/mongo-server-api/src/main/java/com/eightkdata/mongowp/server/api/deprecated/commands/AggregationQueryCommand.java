 ...
 * matteom
 */
public enum AggregationQueryCommand implements QueryCommandProcessor.QueryCommand {
    aggregate,
    //count, //Removed: Use the new API
    distinct,
    group,
    mapReduce
    ;
    ...
    private AggregationQueryCommand() {
    	this.key = name();
    }
    
    private AggregationQueryCommand(String key) {
    	this.key = key;
    }
