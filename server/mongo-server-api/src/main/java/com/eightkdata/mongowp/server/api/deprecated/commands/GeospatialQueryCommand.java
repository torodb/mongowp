 ...
 * matteom
 */
public enum GeospatialQueryCommand implements QueryCommandProcessor.QueryCommand {
    geoNear,
    geoSearch,
    //geoWalk
    ;
    ...
    private GeospatialQueryCommand() {
    	this.key = name();
    }
    
    private GeospatialQueryCommand(String key) {
    	this.key = key;
    }
