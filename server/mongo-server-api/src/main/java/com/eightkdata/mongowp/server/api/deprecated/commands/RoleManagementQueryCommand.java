 ...
 * matteom
 */
public enum RoleManagementQueryCommand implements QueryCommandProcessor.QueryCommand {
    createRole,
    ...
    private RoleManagementQueryCommand() {
    	this.key = name();
    }
    
    private RoleManagementQueryCommand(String key) {
    	this.key = key;
    }
